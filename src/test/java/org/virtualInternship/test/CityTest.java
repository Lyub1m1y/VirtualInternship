...
public class CityTest {
  ...
  public void testCityToString() {
    String expectedStr1 = "City{name='Адыгейск', region='Адыгея', district='Южный', population=12248, foundation='1973'}";
    String expectedStr2 = "City{name='Майкоп', region='Адыгея', district='Южный', population=144246, foundation='1857'}";
    String expectedStr3 = "City{name='Горно-Алтайск', region='Алтай', district='Сибирский', population=56928, foundation='1830'}";
